...
mydb = pymysql.connect(host='127.0.0.1',user='root',passwd='root1234',database = "phonepe_database")
...
if selected == "Home":
    st.image(Image.open("C:/Users/karth/OneDrive/Desktop/program/phonepay.png"),width=400)
    ...
    with col2:
        st.image(Image.open("C:/Users/karth/OneDrive/Desktop/program/php.png"),width=300)
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:/Users/karth/Downloads/DTM13 Practice/State_list .csv")
            df1.State = df2
